...
class GameGrid(Frame):
    ...
    def init_grid(self):
        ...
        scoreCell = Frame(background, bg=BACKGROUND_COLOR_CELL_EMPTY, width=SIZE, height=SIZE / GRID_LEN)
        scoreCell.grid(row=0, column=2, columnspan=2, sticky=E+W, padx=GRID_PADDING, pady=GRID_PADDING)
        scoreText = Label(master=scoreCell, text=str(self.totalScore), bg="#3C3738", fg="#BDC0BA",  justify=RIGHT, font=FONT, width=4, height=2)
        #scoreText.grid()
